...
// Forward decl.
__device__ 
bool update(int location, int s, int r, int *out);
 ...
 */
__global__ 
void compare_kernel_new_s_hj(int *output_buffer, int outsize, a_t* a, b_t* b, x_t* x, y_t* y, 
 ...
 */
__global__ 
void cleanup_kernel_new_s_hj(int *output_buffer, int outsize, a_t* a, b_t* b, x_t* x, y_t* y, 
		int s_count, int r_count) {
